...
public class SubmitButton extends StringValuedControl
{
    public SubmitButton(String name, String paramValue)
    {
    ...
    {
    	i.assertInput(getName(), getValue()).assertAttribute("type", "submit");
    }
}